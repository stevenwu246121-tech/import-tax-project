...
CREATE TABLE purchase_order (
    ...
    duty_total DECIMAL(15,2) NOT NULL,
    vat_total DECIMAL(15,2) NOT NULL,
    landed_cost_total DECIMAL(15,2) NOT NULL,
...
('TW', 'TW', 8, 8.00, 5.00, '2024-01-01', '2099-12-31');

INSERT INTO purchase_order
(order_no, supplier_name, import_country, origin_country, currency_code, exchange_rate,
 subtotal, duty_total, vat_total, landed_cost_total, status)
VALUES
('PO20250519001', 'Japan Foods Supplier', 'TW', 'JP', 'TWD', 1.0000,
 7400.00, 538.00, 396.90, 8334.90, 'CONFIRMED');

INSERT INTO purchase_order_item
(purchase_order_id, product_id, quantity, unit_price, subtotal,
 duty_rate, duty_amount, vat_rate, vat_amount, landed_cost)
VALUES
...
(region_code, name, tax_rate, tax_mode, rounding_mode)
VALUES
('TW', '台灣', 5.00, 'VAT', 'ROUND'),
('JP_IN', '日本內用', 10.00, 'VAT', 'ROUND'),
('JP_OUT', '日本外帶', 8.00, 'VAT', 'ROUND');