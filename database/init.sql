...
INSERT INTO hs_code(code, name, description)
VALUES
('0901.11.0000', '咖啡豆', '日本咖啡豆'),
('1006.30.0000', '白米', '日本白米'),
('1902.30.0000', '即食麵', '日本拉麵、泡麵'),
('0902.10.0000', '抹茶粉', '日本茶粉類'),
('0201.30.0000', '和牛', '日本牛肉'),
('0302.14.0000', '鮭魚', '日本鮭魚'),
('0306.17.0000', '冷凍蝦', '日本冷凍蝦');
