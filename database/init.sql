...
VALUES
('0901.11.0000', '咖啡豆', '乾貨', 5.00, 5.00, '日本咖啡豆，未焙炒咖啡豆'),
('1006.30.0000', '白米', '乾貨', 8.00, 5.00, '日本白米、精米類'),
('1902.30.0000', '即食麵', '乾貨', 12.00, 5.00, '日本拉麵、泡麵、加工麵食'),
('0902.10.0000', '抹茶粉', '乾貨', 6.00, 5.00, '日本茶粉類'),
('0201.30.0000', '和牛', '肉品', 15.00, 5.00, '日本牛肉'),
('0302.14.0000', '鮭魚', '海鮮', 10.00, 5.00, '日本鮭魚、水產品'),
...
(order_no, supplier_name, subtotal, duty_total, vat_total, landed_cost_total, status)
VALUES
('PO20250519001', 'Japan Foods Supplier', 7400.00, 538.00, 396.90, 8334.90, 'CONFIRMED');

INSERT INTO purchase_order_item
(purchase_order_id, product_id, quantity, unit_price, subtotal, duty_rate, duty_amount, vat_rate, vat_amount, landed_cost)
VALUES
(1, 1, 10, 500.00, 5000DROP DATABASE IF EXISTS import_tax_db;
